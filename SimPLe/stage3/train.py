...
def main():
    ...
    train_data_21 = os.listdir('/data/zym/workspace/noisy/noisy_label_resample_1.0X0.6X0.6')
    train_data_list = train_data_21
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        while fg_sample is not None and bg_sample is not None:
            ...
            fg_outs, _ = net(fg_img)
            bg_outs, _ = net(bg_img)

            loss = CE(fg_outs, fg_seg) + CE(bg_outs, bg_seg)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='/data/zym/experiment/noisy/stage3')
