...
def main():
    ...
    for epoch_num in tqdm(range(math.ceil(max_iter / len(fg_dataloader))), ncols=70):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='/data/zym/experiment/noisy/stage2')
    # parser.add_argument('--exp_name', type=str, default='/data/zym/experiment/noisy/rebuttal/DEBUG')

    parser.add_argument('--pretrain', type=str, default='/data/zym/experiment/noisy/stage1/epoch_200.pth')
    parser.add_argument('--omega_', type=float, default=0.1)
    parser.add_argument('--alpha_', type=float, default=0.96)
    parser.add_argument('--lambda_', type=float, default=0.96)
    ...
    parser.add_argument('--save_per_iter', type=int, default=10)
